# -*- coding: utf-8 -*-
"""Verossimilhança.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DSqLJOGHNSAWocBnM1Z5yChaeAAJDPCE
...
def r_squared(alpha, beta, x, y):
    ...
    y_aux = y - y_predict
    r_2 = 1 - (y_aux.T.dot(y_aux))/(y_norm.T.dot(y_norm))
...
def linear_regression(x, y):
  ...
  beta = (x_norm.dot(y_norm.T))/(x_norm.dot(x_norm))
...
def error_verification(alpha, beta, x, y):
  ...
  return total_maiores, total_menores
